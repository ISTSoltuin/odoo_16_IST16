...
#                     if prod_dict.has_key(income.insurance_company.id):
                    if income.payment_state == 'partial':
                        if income.insurance_company.id in prod_dict:
                            ...
                            prod_dict[income.insurance_company.id][2] += (income.amount_total - income.amount_residual)
                        else:
                            prod_dict[income.insurance_company.id] = [income.insurance_company.name, 1, (income.amount_total - income.amount_residual)]
                    else:
