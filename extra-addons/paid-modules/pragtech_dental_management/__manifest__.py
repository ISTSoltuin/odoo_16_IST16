# -*- encoding: utf-8 -*-
{
    ...
    'depends': ['base', 'website', 'sale_management', 'sale_stock', 'purchase', 'account', 'product', 'account',
...
""",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'pragtech_dental_management/static/src/js/widgets.js',
            'pragtech_dental_management/static/src/js/chart_action.js',
            'pragtech_dental_management/static/src/js/image_action.js',
            'pragtech_dental_management/static/src/xml/**/*',
        ],
