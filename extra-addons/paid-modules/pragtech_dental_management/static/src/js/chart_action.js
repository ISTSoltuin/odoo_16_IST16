...
//					console.log('selected_surface',selected_surface,selected_surface.length)
				...
				self.get_treatment_cats().then(function(res) {
					...
					var total_list_div = '';
					console.log("total_list_div", total_list_div)
					for (var j = 0; j < treatment_list.length; j++) {
						total_list_div += '<div class="panel-heading"><h4 class="panel-title"><a id="categ_' + treatment_list[j].treatment_categ_id + '"data-bs-toggle="collapse" href="#collapse' + treatment_list[j].treatment_categ_id + '">' + treatment_list[j].name + '</a></h4></div>';
						total_list_div += '<div id="collapse' + treatment_list[j].treatment_categ_id + '" class="collapse"><div class="panel-body">';
