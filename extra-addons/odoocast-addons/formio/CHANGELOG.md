...
- Change `/config` and `/submission` endpoints from HTTP POST to GET request methods.
- Explicitly add the response header 'Content-Type': 'application/json' to those GET requests.
